...
data.frame(
  ...
  knitr::kable(col.names = c("Method","Handles Trend","Handles Seasonal",
                              "Multi-step","n","MSE"),
               align = "c",
               caption = "† Holt-Winters MSE is from the quarterly example (n=8); all other methods use the annual price example (n=6). Direct MSE comparison across different datasets is not meaningful.")
```

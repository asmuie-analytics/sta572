...
::: {.callout-tip}
**Exercise:** Using the estimated ARIMA(2,1,1) coefficients and the last three
observed values plus their residuals, prove the one-step and two-step-ahead
point forecasts manually.
:::
